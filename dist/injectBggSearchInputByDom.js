(function (React, ReactDOM, bggXmlApiClient) {
  'use strict';
  ...
  var bggXmlApiClient__default = /*#__PURE__*/_interopDefaultLegacy(bggXmlApiClient);
  ...
  */
    ...
    var onInputChange = React.useCallback(function (newValue, actionMeta) {
      ...
      if (cacheOptions && optionsCache[inputValue]) {
        ...
        loadOptions(inputValue, function (options) {
          ...
          setPassEmptyOptions(false);
          setOptionsCache(options ? _objectSpread2(_objectSpread2({}, optionsCache), {}, _defineProperty$1({}, inputValue, options)) : optionsCache);
        });
      }
  ...
  const BggSearchInput = ({
    ...
    const getBggGame = React.useCallback(async name => {
      const {
        data
      } = await bggXmlApiClient__default["default"].get("search", {
        query: name,
        type: "boardgame"
      }); // console.log(data);
      ...
      const res = items.map(({
        ...
        const year = yearpublished === null || yearpublished === void 0 ? void 0 : yearpublished.value;
        return {
    ...
    const throttleRequest = React.useCallback(throttle(async (val, callback) => {
      if (val) {
    ...
    const debounceGet = React.useCallback(debounce((val, callback) => {
      throttleRequest(val, callback);
    }, 1500), []);
    const loadOptions = React.useCallback((val, callback) => {
      debounceGet(val, callback);
    }, []);
    return /*#__PURE__*/React__default["default"].createElement(AsyncSelect, _extends$1({
  ...
  function injectBggSearchInputByDom(Dom, props) {
    ReactDOM__default["default"].render( /*#__PURE__*/React__default["default"].createElement(React__default["default"].StrictMode, null, /*#__PURE__*/React__default["default"].createElement(BggSearchInput, props)), Dom);
    return () => {
...
})(React, ReactDOM, bggXmlApiClient);
//# sourceMappingURL=injectBggSearchInputByDom.js.map
